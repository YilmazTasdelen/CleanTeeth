...
namespace CleanTeeth.Domain.Entities
{
    public class Appointment
    {
        ...
        public Appointment(Guid patientId, Guid dentistId, Guid dentalOfficeId, TimeInterval timeInterval)
        {
            ...
            {
                throw new BusinessRuleException($"The start time cant be in the past");
            }
        ...
        public void Cancel()
        {
            ...
            {
                throw new BusinessRuleException("Only scheduled appointment can be canceled");
            }
        ...
        public void Complete()
        {
            if (Status != AppointmentStatus.Scheduled)
            {
                throw new BusinessRuleException("Only scheduled appointment can be completed");
            }
